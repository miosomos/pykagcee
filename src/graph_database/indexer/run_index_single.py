...
os.environ["PATH"] = (
    os.path.dirname(os.path.abspath(__file__)) + ";" + os.environ["PATH"]
)
...
def run():
    ...
    parser.add_argument("--url", help="neo4j url", type=str, default="", required=False)
    parser.add_argument(
    ...
    parser.add_argument("--env", help="env", type=str, default="", required=False)
